...
const bottomRowLeft: KeyData[] = [
  { primary: 'caps', type: 'caps', width: 1.5, label: 'CAPS' },
...
const bottomRowRight: KeyData[] = [
  { primary: 'backspace', type: 'backspace', width: 1.5, label: '⌫' },
];
...
const spaceRow: KeyData[] = [
  ...
  { primary: ' ', type: 'space', width: 4.8, label: 'Space' },
  { primary: ',', secondary: ',', type: 'punctuation' },
  { primary: '.', secondary: '.', type: 'punctuation' },
  { primary: 'enter', type: 'enter', width: 1.4, label: 'return' },
];
...
const symbolRow4: KeyData[] = [
  { primary: '#+=', type: 'symbol', width: 1.5, label: '#+=' },
  { primary: '[', secondary: '{', type: 'punctuation' },
  { primary: ']', secondary: '}', type: 'punctuation' },
  { primary: '<', secondary: '«', type: 'punctuation' },
  { primary: '>', secondary: '»', type: 'punctuation' },
