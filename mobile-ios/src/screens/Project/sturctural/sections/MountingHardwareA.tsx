// src/screens/Project/structural/sections/MountingHardwareA.tsx
...
export default function MountingHardwareA({
  values,
  onChange,
  errors = {},
  onNext,
  ...
  const sectionLabel = "Mounting Hardware (A)";
  ...
  return (
    <>
      <ConfirmClearModal
        visible={showClear}
        sectionTitle="Mounting Hardware (A)"
        onConfirm={() => {
          clearAll();
          setShowClear(false);
          setExpanded(false);
